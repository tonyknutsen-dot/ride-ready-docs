      ...
      <div className="grid grid-cols-4 gap-3">
        {quickNavItems.map(item => (
          <button
            ...
            className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-border bg-card active:scale-[0.96] transition-all group relative shadow-card hover:shadow-card-hover hover:-translate-y-0.5 hover:border-primary"
          >
            <div className="p-2 rounded-xl border border-border bg-secondary group-hover:bg-[#F1F5F9] group-hover:border-primary transition-all relative">

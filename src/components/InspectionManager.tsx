    ...
    <div className="space-y-2 md:space-y-3">
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <div className="h-6 w-6 md:h-7 md:w-7 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
        ...
        <Button
          ...
          className="text-muted-foreground hover:text-foreground h-6 px-2 shrink-0"
          aria-label="Help"
        >
      ...
      <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); setShowNextPrompt(null); }} className="space-y-1.5 md:space-y-2 relative">

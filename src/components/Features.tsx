  ...
  const features = [
    {
      ...
      description: "Risk assessments, method statements, insurance certificates, technical bulletins - everything organized by ride and equipment, easily accessible.",
    ...
    },
    {
      ...
      description: "Access the latest technical bulletins for your rides and equipment types. Stay informed about updates and modifications.",
      items: ["Chair-o-Plane Bulletins", "Ride-Specific Updates", "Equipment Notices", "Safety Alerts"]
    },
    {

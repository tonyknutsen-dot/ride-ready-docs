...
const CallToAction = () => {
  ...
  return <section className="py-20 bg-primary text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground px-8 py-4 text-lg font-semibold shadow-glow transition-smooth min-w-[250px]" onClick={() => navigate('/auth')}>
            Start Free 30-Day Trial
          </Button>
          <Button variant="outline" size="lg" className="border-2 border-white text-white bg-black/40 hover:bg-black/60 px-8 py-4 text-lg backdrop-blur-sm transition-smooth min-w-[250px]" onClick={() => navigate('/demo')}>
            View Demo
          </Button>
        </div>

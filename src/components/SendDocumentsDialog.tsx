    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-xl max-h-[90vh] overflow-hidden flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 px-5 py-4">
          {/* Sender Information */}
          <div className="bg-muted/50 border border-border rounded-xl p-3.5 space-y-1">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div>
                <Label htmlFor="recipientEmail" className="text-xs font-semibold text-foreground mb-1.5 block">
                  Email Address *
                </Label>
                <Input
                  id="recipientEmail"
              ...
              <div>
                <Label htmlFor="recipientName" className="text-xs font-semibold text-foreground mb-1.5 block">
                  Name / Organisation
                </Label>
                <Input
                  id="recipientName"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-foreground/60">{totalSelectedDocs} selected</span>
            </div>
        ...
        {/* Sticky footer */}
        <div className="flex-shrink-0 flex gap-3 px-5 py-4 border-t border-border bg-background shadow-[0_-2px_8px_rgba(0,0,0,0.04)]">

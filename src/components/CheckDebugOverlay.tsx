...
const MARKERS = [
  ...
  'execution UI ready',
  'save started',
  'source check save finished',
  'inspection record create started',
  'inspection record create finished',
  'inspection record create failed',
  'fallback lookup started',
  'fallback lookup finished',
  'fallback lookup failed',
  'UI save state cleared',
  'navigate called / checks list refresh called',

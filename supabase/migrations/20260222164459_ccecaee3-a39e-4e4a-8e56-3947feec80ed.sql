...
-- Create a database view that unifies all timeline-relevant events
...
-- 4. Compliance Events (annual inspections, NDT, electrical, etc.)
SELECT
...
-- 5. Inspection Record Amendments (versioned records)
SELECT
...
COMMENT ON VIEW public.timeline_events IS 'Unified timeline view combining checks, defects, maintenance, compliance events, and inspection amendments for reporting purposes.';

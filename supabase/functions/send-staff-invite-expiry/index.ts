          ...
          html: `
            ...
            <head>
              <style>
                ...
                .header { background-color: #FF6B35; background-image: linear-gradient(135deg, #FF6B35, #F7931A); color: white; padding: 30px; border-radius: 10px 10px 0 0; text-align: center; }
